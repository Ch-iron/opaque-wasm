...
async function run() {
  ...
  const registration_server_s_pk = client_registration.getServerSPK();
  ...
  console.log('registration server_s_pk', registration_server_s_pk);
  console.log('login server_s_pk', client_login.getServerSPK());
}
